...
FriendSDK **v0.1.1** runs a game component in a **960 × 640** container. The package
...
leave space for those controls when placing HUD elements. Its 3:2 aspect ratio
